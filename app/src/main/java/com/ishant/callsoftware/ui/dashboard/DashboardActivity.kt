package com.ishant.callsoftware.ui.dashboard
...
import com.ishant.callsoftware.navigation.navhost.host.dashboard.HomeNavHost
...
import com.ishant.callsoftware.utils.NotificationListenerUtil
import com.ishant.callsoftware.utils.addAutoStartup
...
private fun requestUnusedAppPermission(context: Context) {
    val intent = Intent(Settings.ACTION_APPLICATION_DETAILS_SETTINGS).apply {
        data = Uri.fromParts("package", "com.ishant.callsoftware", null)
    }
