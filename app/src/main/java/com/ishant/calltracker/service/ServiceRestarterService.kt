...
class ServiceRestarterService : Service() {
    ...
    private fun startServiceMonitoring() {
        ...
        if (!isServiceRunning(ServiceRestarterService::class.java)) { // Replace with your service class
            Log.e(TAG, "CallTracker : Service > ServiceRestarterService > ServiceRestart ")
            val intentNew = Intent(this, ServiceRestarterService::class.java)
