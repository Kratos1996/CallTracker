package com.ishant.LKing.ui.dashboard
...
import com.ishant.LKing.navigation.navhost.host.dashboard.HomeNavHost
...
import com.ishant.LKing.utils.NotificationListenerUtil
import com.ishant.LKing.utils.addAutoStartup
...
private fun requestUnusedAppPermission(context: Context) {
    val intent = Intent(Settings.ACTION_APPLICATION_DETAILS_SETTINGS).apply {
        data = Uri.fromParts("package", "com.ishant.LKing", null)
    }
