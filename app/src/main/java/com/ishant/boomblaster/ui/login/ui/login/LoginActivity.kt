    ...
    private fun showSettingDialog() {
        MaterialAlertDialogBuilder(
            ...
            .setPositiveButton("Ok") { _, _ ->
                ...
                intent.data = Uri.parse("package:com.ishant.boomblaster")
