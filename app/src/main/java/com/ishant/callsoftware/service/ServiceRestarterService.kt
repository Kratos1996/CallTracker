...
import com.ishant.callsoftware.utils.callForegroundService
...
class ServiceRestarterService : Service() {
    ...
    companion object {
        ...
        const val SERVICE_TO_RESTART = "com.ishant.callsoftware.service.CallService" // Replace with your service name
    }
