...
import com.ishant.jagtap.navigation.navhost.host.dashboard.HomeNavHost
import com.ishant.jagtap.service.CallService
import com.ishant.jagtap.service.ContactSyncService
import com.ishant.jagtap.service.KeepAliveService
import com.ishant.jagtap.utils.NotificationListenerUtil
import com.ishant.jagtap.utils.addAutoStartup
...
private fun requestUnusedAppPermission(context: Context) {
    val intent = Intent(Settings.ACTION_APPLICATION_DETAILS_SETTINGS).apply {
        data = Uri.fromParts("package", "com.ishant.jagtap", null)
    }
